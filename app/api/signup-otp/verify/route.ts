...
//
// No attempt limit yet — a 6-digit code has 1,000,000 combinations, so this
// needs rate limiting before it's relied on for anything beyond "requires a
// code Tony was handed," which is the next piece of work.
